...
class Portfolio extends \common\models\BaseModel
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['is_private', 'is_private', 'order_id', 'price', 'price_lead', 'type_id'], 'integer'],
            [['conversion'], 'number'],
    ...
    public function getUrlParams($type = null)
    {
        $typeParam = $type ? $type : Yii::$app->request->get('type');
        if($typeParam == Portfolio::PRIVATE_PARAM) {
            return '?type='.Portfolio::PRIVATE_PARAM;
        }
        return false;
    }
}
