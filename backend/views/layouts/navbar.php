...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <!--
        <li class="nav-item d-none d-sm-inline-block">
            <a href="<?//= Url::to(['office/index']) ?>" class="nav-link">Делопроизводство</a>
        </li>
        -->
        <li class="nav-item d-none d-sm-inline-block">
        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                ...
                <li><a href="<?= Url::to(['tag/index']) ?>" class="dropdown-item">Теги</a></li>
                ...
                <li><a href="<?= Url::to(['visitor/index']) ?>" class="dropdown-item">Посетители</a></li>
                <li><a href="<?= Url::to(['quiz/index']) ?>" class="dropdown-item">Опросы</a></li>
            </ul>
        </li>
    </ul>
